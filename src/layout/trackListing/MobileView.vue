...
<template>
  <ul class="flex flex-col gap-4 items-center py-6 ">
    <li v-for="track in tracks" :key="track.id" class="flex justify-center w-full">
      <TrackCard :track="track" :currentUrlTrackPlaying="currentUrlTrackPlaying"
