...
<template>
  <header class="px-5 xl:px-0">
    <div class="header-content flex w-full h-full">
      <div class="header-logo flex items-center text-white gap-3 cursor-pointer" v-on:click="() => $router.push('/')">
